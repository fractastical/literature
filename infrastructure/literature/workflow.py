...
**DEPRECATED**: This module is deprecated. Use `infrastructure.literature.workflow.workflow` 
module instead, which is the active implementation with proper package structure.

The workflow functionality has been moved to `infrastructure/literature/workflow/workflow.py`
as part of the workflow package. All imports should use:
    from infrastructure.literature.workflow import LiteratureWorkflow, WorkflowResult

This file is kept for backward compatibility but will be removed in a future version.

Classes:
    LiteratureWorkflow: Main workflow orchestrator (DEPRECATED - use workflow.workflow.LiteratureWorkflow)
    WorkflowResult: Result container for workflow operations (DEPRECATED - use workflow.workflow.WorkflowResult)
"""
