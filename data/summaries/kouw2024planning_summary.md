...
The authors conclude that agents should be designed to account for the curvature of the measurement function to avoid states where the measurement function is highly non-linear." 

The authors suggest that future research should focus on developing more sophisticated methods for estimating the curvature of the measurement function. 

The authors state: "

The authors argue that future research should focus on developing more sophisticated methods for estimating the curvature of the measurement function."
